...
if command -v sshd &> /dev/null && [ -d /var/run/sshd ] && command -v git &> /dev/null && command -v Xvfb &> /dev/null && command -v x11vnc &> /dev/null && command -v nginx &> /dev/null && command -v netstat &> /dev/null && command -v xfce4-session &> /dev/null && command -v ffmpeg &> /dev/null; then
